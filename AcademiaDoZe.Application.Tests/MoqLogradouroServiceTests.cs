...
namespace AcademiaDoZe.Application.Tests
{
    public class MoqLogradouroServiceTests
    {
        ...
        public async Task ObterPorIdAsync_DeveRetornarLogradouro_QuandoExistir()
        {
            ...
            _logradouroServiceMock
                .Setup(s => s.ObterPorIdAsync(logradouroId))
                .ReturnsAsync(logradouroDto);
        ...
        public async Task AdicionarAsync_DeveAdicionarLogradouro_QuandoDadosValidos()
        {
            ...
            _logradouroServiceMock
                .Setup(s => s.AdicionarAsync(It.IsAny<LogradouroDTO>()))
                .ReturnsAsync(logradouroCriado);
        ...
        public async Task AtualizarAsync_DeveAtualizarLogradouro_QuandoDadosValidos()
        {
            // Arrange
            var logradouroId = 1;
            var logradouroExistente = new LogradouroDTO
            {
                Id = logradouroId,
                Cep = "12345678",
                Nome = "Rua Antiga",
            ...
            var logradouroAtualizado = new LogradouroDTO
            {
                Id = logradouroId,
                Cep = "12345678",
                Nome = "Rua Atualizada",
            ...
            _logradouroServiceMock
                .Setup(s => s.AtualizarAsync(It.IsAny<LogradouroDTO>()))
                .ReturnsAsync(logradouroAtualizado);
