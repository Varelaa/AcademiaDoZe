...
namespace AcademiaDoZe.Domain.Entities
{
    public sealed class Logradouro : Entity
    {
        ...
        private Logradouro(int id, string cep, string nome, string bairro, string cidade, string estado, string pais)
            : base(id)
        {
            Cep = cep;
            Nome = nome;
        ...
        {
            return Criar(0, cep, nome, bairro, cidade, estado, pais);
        }
    }
}
